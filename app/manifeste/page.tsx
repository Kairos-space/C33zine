    ...
    <article lang="fr">
      ...
      <div className="px-6 md:px-10 py-12 md:py-20">
        <div className="max-w-prose mx-auto prose-c33" lang="zh-CN">
          ...
          <p>
            我们相信,今天关于时尚与品牌的讨论太快了——快到来不及看清楚一个叙事是怎么被搭起来的、一种符号是怎么被翻译和误读的、一段供应链是怎么变成一个故事的。我们用季度的节奏,把这道速度慢下来。
          </p>
          ...
          <p>
            我们站在中国与法国之间——不彻底属于任何一边,因此能看见两边各自看不见的东西。同一件事,在中文语境和法语语境下,本来就应该被讲两次,而不是一次再加一个字幕。
          </p>
          ...
          <p>
            我们拒绝用一把尺子只量别人。在创刊号里,我们用审视品牌、审视影视、审视跨境项目的同一把尺子,也审视媒体行业自己——包括我们自己。
          </p>

          <h2>我们相信什么</h2>
          <p>
            我们相信慢、相信长文、相信印刷感优先于即时性。我们相信一本刊物可以同时是中文的,也是法语的,而不必牺牲任何一边的厚度。我们相信,只有先把一件事看清楚,才知道这个行业里值得被尊重的工作究竟长什么样。
          </p>
